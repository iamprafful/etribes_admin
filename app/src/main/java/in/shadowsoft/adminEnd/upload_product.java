...
public class upload_product extends AppCompatActivity
    ...
    String sname,phone,pName,pdes,pCost,sAdd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sAdd=getIntent().getStringExtra("sAdd");
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.upload_product, menu);
        return true;
    }
    ...
    public void uploadMultipart() {
        ...
        try {
            ...
            String name = pName.replace(" ","_")+uploadId;

            //Creating a multi part request
            new MultipartUploadRequest(this, uploadId, "http://ciphers.shadowsoft.in/tribal/sell.php")
                    .addFileToUpload(path, "image") //Adding file
                    .addParameter("name", name) //Adding text parameter to the request
                    .addParameter("product_name",pName)
                    .addParameter("description",pdes)
                    .addParameter("cost",pCost)
                    .addParameter("shop_address",sAdd)
                    .addParameter("seller_phone",phone)
                    .addParameter("seller_name",sname)
