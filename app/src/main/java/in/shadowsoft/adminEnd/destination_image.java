...
public class destination_image extends AppCompatActivity
    ...
    String dName, sDes, fDes, dAdd ,lat,lng;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_destination_image);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.destination_image, menu);
        return true;
    }
    ...
    public void launch_destination_finish(MenuItem item) {
        uploadMultipart();
    }
    ...
    public void uploadMultipart() {
        ...
        try {
            ...
            String name = dName.replace(" ","_")+uploadId;
            Log.e("n",name);
            //Creating a multi part request
            new MultipartUploadRequest(this, uploadId, "http://ciphers.shadowsoft.in/tribal/add_destination.php")
                    .addFileToUpload(path, "image") //Adding file
                    .addParameter("hName", dName)
                    .addParameter("short_des", sDes)
                    .addParameter("hDes", fDes)
                    .addParameter("hAdd", dAdd)
